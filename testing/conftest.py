...
"""Alta3 Research | controlling pytest behaviors with conftest.py
   ...
   Answer: The monkeypatch fixture helps you to safely set/delete an attribute, 
   dictionary item or environment variable, or to modify sys. path for importing during testing.
"""
